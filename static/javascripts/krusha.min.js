...
krusha.config([ "$routeProvider", "$httpProvider", "$compileProvider", "$locationProvider", "$tooltipProvider", function($routeProvider, $httpProvider, $compileProvider, $locationProvider, $tooltipProvider) {
    $routeProvider.when("/", {
...
krusha.controller("showCtrl", [ "$scope", "$routeParams", "$cookies", "$timeout", "apiShow", "apiReddit", "apiImdb", "notifications", "loggedin", function($scope, $routeParams, $cookies, $timeout, apiShow, apiReddit, apiImdb, notifications, loggedin) {
    $scope.show = {};
    $scope.seasons = {};
    $scope.tracked = null;
    $scope.reddit = [];
