...
var onloadCallback = function() {
    grecaptcha.render("recaptcha", {
        sitekey: "6Lf3Pf8SAAAAADPdiYyjbvd9dHLxY8ZvxJDwKGxY"
    });
};
...
krusha.config([ "$routeProvider", "$httpProvider", "$compileProvider", "$locationProvider", "$tooltipProvider", "ngClipProvider", "hotkeysProvider", function($routeProvider, $httpProvider, $compileProvider, $locationProvider, $tooltipProvider, ngClipProvider, hotkeysProvider) {
    $routeProvider.when("/", {
...
krusha.directive("dates", [ "$filter", "calendar", function($filter, calendar) {
    var addDay = function(row, day, changeToDay) {
        if (typeof day !== "undefined") {
            var date_cell = $("<td/>");
            var date = $("<div/>");
            date.addClass("date").text(day.date.getDate()).on("click", function() {
...
krusha.controller("profileCtrl", [ "$scope", "$cookieStore", "apiSettings", "apiImdb", "apiReddit", "notifications", "loggedin", "hotkeys", function($scope, $cookieStore, apiSettings, apiImdb, apiReddit, notifications, loggedin, hotkeys) {
...
krusha.controller("showCtrl", [ "$scope", "$routeParams", "$cookies", "$cookieStore", "$timeout", "apiShow", "apiReddit", "apiImdb", "notifications", "loggedin", function($scope, $routeParams, $cookies, $cookieStore, $timeout, apiShow, apiReddit, apiImdb, notifications, loggedin) {
    ...
    var today = new Date();
    $scope.display = typeof $cookieStore.get("display") !== "undefined" ? $cookieStore.get("display") : {
        reddit: true,
        imdb: true
    };
    $scope.$on("loggedin", function() {
