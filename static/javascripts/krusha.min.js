...
krusha.controller("profileCtrl", [ "$scope", "apiSettings", function($scope, apiSettings) {
    ...
    $scope.dateFormats = [ {
        value: "yyyy-MM-dd",
        display: "yyyy-MM-dd (2010-31-12)"
    }, {
        value: "dd.MM.yyyy",
        display: "dd.MM.yyyy (31.12.2010)"
    }, {
        value: "MM/dd/yyyy",
        display: "MM/dd/yyyy (12/31/2010)"
    } ];
    var now = new Date();
    now.setHours(0);
    now.setMinutes(0);
...
krusha.controller("showCtrl", [ "$scope", "$routeParams", "$cookies", "$filter", "apiShow", "apiReddit", "apiImdb", "helpers", "notifications", "loggedin", function($scope, $routeParams, $cookies, $filter, apiShow, apiReddit, apiImdb, helpers, notifications, loggedin) {
    $scope.show = {};
    $scope.seasons = {};
    $scope.tracked = null;
    $scope.reddit = [];
